...
export default {
  ...
  "ui.conflict.log_message": "偵測到伺服端衝突副本：${copy}（原檔案：${original}）",
  "ui.conflict.log_resolved_keep_current": "衝突已處理：保留 ${path} 目前內容，衝突副本已刪除",
  "ui.conflict.log_resolved_overwrite": "衝突已處理：已用衝突副本覆蓋 ${path}",
  "ui.conflict.menu_item": "解決衝突",
  "ui.conflict.modal_title": "衝突合併",
  "ui.conflict.keep_current": "保留目前",
  "ui.conflict.keep_current_desc": "刪除衝突副本，保留目前檔案內容",
  "ui.conflict.keep_current_success": "已保留目前內容，衝突副本已刪除",
  "ui.conflict.overwrite_with_copy": "用副本覆蓋",
  "ui.conflict.overwrite_with_copy_desc": "用衝突副本內容覆蓋目前檔案，隨後刪除副本",
  "ui.conflict.overwrite_success": "已用衝突副本覆蓋目前檔案",
