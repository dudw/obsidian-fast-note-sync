...
export default {
  ...
  // --- ui.conflict ---
  "ui.conflict.notice": "Conflict copy detected for ${path}. Click to resolve.",
  "ui.conflict.log_message": "Detected server-side conflict copy: ${copy} (original: ${original})",
  "ui.conflict.log_resolved_keep_current": "Conflict resolved: kept current content for ${path}, conflict copy deleted",
  "ui.conflict.log_resolved_overwrite": "Conflict resolved: overwrote ${path} with the conflict copy",
  "ui.conflict.menu_item": "Resolve conflict",
  "ui.conflict.modal_title": "Resolve conflict",
  ...
  "ui.conflict.keep_current_success": "Kept current content, conflict copy deleted",
  "ui.conflict.overwrite_with_copy": "Overwrite with copy",
  "ui.conflict.overwrite_with_copy_desc": "Overwrite the current file with the conflict copy's content, then delete the copy",
  "ui.conflict.overwrite_success": "Current file overwritten with the conflict copy",
  "ui.conflict.side_by_side": "View side by side",
  "ui.conflict.side_by_side_desc": "Open the original file and the conflict copy in two panes to merge manually",
  "ui.conflict.delete_conflict_copy": "Delete conflict copy",
  "ui.conflict.original_missing": "The original file is missing, it may have been deleted",
  "ui.conflict.diff_too_large": "The files are too large to diff. Please use \"View side by side\" to compare manually",
  "ui.conflict.action_failed": "Failed to resolve the conflict, please try again",
};
